...
public class WorldTests {
    ...
    public void getRandomVacantSpotReturnsRandomTileWhenThereAreNoObstacles() {
        ...
        final IWorld world = new MockWorld(10, 12345, mockRandom);
    ...
    public void worldInitiated() {
        ...
        final World world = new World(2, 15, mock(Random.class));
    ...
    public void getNeighboursOfReturnsExpectedNeighbours(
        ...
        // Arrange
        final IWorld world = new World(3, 15, mock(Random.class));
